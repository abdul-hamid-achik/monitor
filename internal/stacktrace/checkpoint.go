...
// (docs/contracts/local-sentry-naming.md §5): the device/inode and size
...
type Checkpoint struct {
	...
	// Inode (CC-2, docs/contracts/local-sentry-naming.md §5), it survives a
...
// CC-4 in docs/contracts/local-sentry-naming.md §5. This is kept as the
...
// seek f to before reading, applying the reset rule (docs/contracts/
// local-sentry-naming.md §5): start over from 0 when fromStart is set, or
